...
/*select * from PassiveBuildings*/

/*CREATE TABLE DefensiveBuildings (
  Card VARCHAR(50),
  Cost INT,
  Health INT,
  Damage VARCHAR(50),
  HitSpeed FLOAT,
  Dps VARCHAR(50),
  AttackRange VARCHAR(50)
);*/



/*select * from DefensiveBuildings*/


/*CREATE TABLE Cards (
  Card VARCHAR(50),
  Cost INT,
  Health_Shield VARCHAR(50),
  Damage VARCHAR(50),
  HitSpeed FLOAT,
  Dps VARCHAR(50),
  Spawn_DeathDamage VARCHAR(50),
  AttackRange VARCHAR(50),
  SpawnCount INT
);*/

/*INSERT INTO PassiveBuildings 
(Card, Cost, Health)
(Card, Cost, Health_Shield, Damage, HitSpeed, Dps, Spawn_DeathDamage, AttackRange, SpawnCount)
VALUES 
...
/*INSERT INTO Cards (Card, Cost, Health_Shield, Damage, HitSpeed, Dps, Spawn_DeathDamage, AttackRange, SpawnCount)
VALUES 
('Archers', 3, '304', '107', 1.1, '97', '0', '5', 2),
('Archer Queen', 5, '1,000', '225', 1.2, '188', '0', '5', 1),
('Arrows', 3, NULL, '122x3', NULL, NULL, NULL, '4', NULL),
...
('Barbarian Barrel', 2, NULL, '241', NULL, NULL, NULL, '4.5 Range, 2.6 Width', NULL),
('Barbarian Hut', 6, 1166, NULL, NULL, NULL, NULL, NULL, 1),
...
('Battle Ram', 4, '911', '286', NULL, NULL, '0', '0.5(Melee: Short)', 1),
('Bomb Tower', 4, 1356, 222, 1.6, 139, NULL, 6, 1),
('Bomber', 2, '332', '222', 1.8, '123', '0', '4.5', 1),
('Bowler', 5, '2,080', '288', 2.5, '115', '0', '4', 1),
('Cannon', 3, 896, 212, 0.9, 236, NULL, 5.5, 1),
('Cannon Cart', 5, '820(+892)', '212', 1, '212', '0', '5.5', 1),
('Dark Prince', 4, '1,200(+240)', '248', 1.3, '190', '0', '1.2(Melee: Medium)', 1),
('Dart Goblin', 3, '260', '131', 0.7, '187', '0', '6.5', 1),
('Earthquake', 3, NULL, '82x3(287 to Buildings)', NULL, NULL, NULL, '3.5', NULL),
('Electro Dragon', 5, '950', '192(x3)', 2.1, '91(x3)', '0', '3.5', 1),
('Electro Giant', 7, '3,536', '163', 2.1, '77', '0', '1.2(Melee: Medium)', 1),
('Electro Spirit', 1, '230', '99', NULL, NULL, '0', '2.5', 1),
('Electro Wizard', 4, '713', '110(x2)', 1.8, '122', '192(Spawn)', '5', 1),
('Elite Barbarians', 6, '1,341', '384', 1.4, '274', '0', '1.2(Melee: Medium)', 2),
('Elixir Collector', 6, 1070, NULL, NULL, NULL, NULL, NULL, 1),
('Elixir Golem', 3, '1,441', '254', 1.1, '195', '0', '0.75(Melee: Short)', 1),
('Executioner', 5, '1,280', '169(x2)', 2.4, '141', '0', '4.5 (Projectile 6.5)', 1),
('Fireball', 4, NULL, '689', NULL, NULL, NULL, '2.5', NULL),
('Firecracker', 3, '304', '64(x5)', 3, '107', '0', '6 (Projectile 11.5)', 1),
('Fire Spirit', 1, '230', '227', NULL, NULL, '0', '2.5', 1),
('Fisherman', 3, '871', '193', 1.3, '148', '0', '1.2(Melee: Medium)/7', 1),
('Flying Machine', 4, '614', '171', 1.1, '155', '0', '6', 1),
('Freeze', 4, NULL, '115', NULL, NULL, NULL, '3', NULL),
('Furnace', 4, 848, NULL, NULL, NULL, NULL, NULL, 1),
('Giant', 5, '4091', '254', 1.5, '169', '0', '1.2(Melee: Medium)', 1),
('Giant Snowball', 2, NULL, '192', NULL, NULL, NULL, '2.5', NULL),
('Giant Skeleton', 6, '3,600', '267', 1.4, '191', '534 (Death, x2 to towers)', '0.8(Melee: Short)', 1),
('Goblin Cage', 4, 742, NULL, NULL, NULL, NULL, NULL, 1),
('Goblin Drill', 4, 1440, NULL, NULL, NULL, NULL, NULL, 1),
('Goblin Gang', 3, '202/133', '120/81', '1.1', '109/48', '0/0', '0.5(Melee: Short)/5', 6),
('Goblin Giant', 6, '3,147', '176', 1.5, '117', '0', '1.2(Melee: Medium)', 1),
('Goblin Hut', 5, 848, NULL, NULL, NULL, NULL, NULL, 1),
...
('Heal Spirit', 1, '231', '110', NULL, NULL, '0', '2.5', 1),
('Ice Golem', 2, '1,197', '84', 2.5, '33', '84(Death)', '0.75(Melee: Short)', 1),
('Ice Spirit', 1, '230', '110', NULL, NULL, '0', '2.5', 1),
('Ice Wizard', 3, '688', '90', 1.7, '53', '84(Spawn)', '5.5', 1),
('Inferno Dragon', 4, '1294', '36-423', 0.4, '90-1057', '0', '3.5', 1),
('Inferno Tower', 5, 1749, '42-848', 0.4, '105-2,120', NULL, 6, 1),
('Knight', 3, '1753', '202', 1.2, '168', '0', '1.2(Melee: Medium)', 1),
('Lava Hound', 7, '3,811', '54', 1.3, '42', '0', '3.5', 1),
('Lightning', 6, NULL, '1056', NULL, NULL, NULL, '3.5', NULL),
...
('Mighty Miner', 4, '2,200', '40/200/400', 0.4, '100/500/1000', '334 (Explosive Escape)', '1.6(Melee: Long)', 1),
...
('Monk', 4, '2,000', '140/420', 0.9, '156', '0', '1.2(Melee: Medium)', 1),
('Mortar', 4, 1472, 266, 5, 53, NULL, '3-11.5', 1),
...
('Phoenix', 4, '1,052', '217', 0.9, '241', '181 (55 to Towers)', '1.6(Melee: Long)', 1),
('Poison', 4, NULL, '91 x8', NULL, NULL, NULL, '3.5', NULL),
('Prince', 5, '1,920', '392', 1.4, '280', '0', '1.6(Melee: Long)', 1),
('Princess', 3, '261', '169', 3, '56', '0', '9', 1),
('Rage', 2, NULL, '192', NULL, NULL, NULL, '3', NULL),
('Ram Rider', 5, '1,767', '266/104', '1.8', '148/95', '0', '0.8(Melee: Short)/5.5', 1),
('Rascals', 5, '1,830', '133', 1.5, '89', '0', '0.8(Melee: Short)', 1),
('Rocket', 6, NULL, '1484', NULL, NULL, NULL, '2', NULL),
('Royal Delivery', 3, NULL, '362', NULL, NULL, NULL, '3', NULL),
...
('Skeleton Barrel', 3, '532', '133', NULL, NULL, '133(Death)', '0.35(Melee: Short)', 1),
...
('Tesla', 4, 1152, 230, 1.2, 191, NULL, 5.5, 1),
('The Log', 2, NULL, '290', NULL, NULL, NULL, '10.1 Range, 3.9 Width', NULL),
('Three Musketeers', 9, '720', '218', 1, '218', '0', '6', 3),
('Tombstone', 3, 530, NULL, NULL, NULL, NULL, NULL, 1),
('Tornado', 3, NULL, '168', NULL, NULL, NULL, '5.5', NULL),
('Valkyrie', 4, '1,908', '267', 1.6, '178', '0', '1.2(Melee: Medium)', 1),
('Wall Breakers', 2, '331', '392', NULL, NULL, '0', '0.5(Melee: Short)', 2),
('Witch', 5, '838', '134', 1.1, '122', '0', '5.5', 1),
('Wizard', 5, '720', '281', 1.4, '201', '0', '5.5', 1),
('X-Bow', 6, 1600, 41, 0.3, 136, NULL, 11.5, 1),
('Zap', 2, NULL, '192', NULL, NULL, NULL, '2.5', NULL),
...
/*
INSERT INTO Cards (Name, Cost, Health_Shield, Damage, HitSpeed, Dps, Spawn_DeathDamage, AttackRange, SpawnCount)
VALUES 
('Archers', 3, '304', '107', 1.1, '97', '0', '5', 2),
('Archer Queen', 5, '1,000', '225', 1.2, '188', '0', '5', 1),
('Arrows', 3, NULL, '122x3', NULL, NULL, NULL, '4', NULL),
...
('Cannon', 3, 896, 212, 0.9, 236, NULL, 5.5, 1),
('Cannon Cart', 5, '820(+892)', '212', 1, '212', '0', '5.5', 1),
('Clone', 3, 1, 'cloned card', 'cloned card', 'cloned card', 'cloned card', 'cloned card', 'cloned card'),
('Dark Prince', 4, '1,200(+240)', '248', 1.3, '190', '0', '1.2(Melee: Medium)', 1),
('Dart Goblin', 3, '260', '131', 0.7, '187', '0', '6.5', 1),
('Earthquake', 3, NULL, '82x3(287 to Buildings)', NULL, NULL, NULL, '3.5', NULL),
('Electro Dragon', 5, '950', '192(x3)', 2.1, '91(x3)', '0', '3.5', 1),
...
('Giant Snowball', 2, NULL, '192', NULL, NULL, NULL, '2.5', NULL),
('Giant Skeleton', 6, '3,600', '267', 1.4, '191', '534 (Death, x2 to towers)', '0.8(Melee: Short)', 1),
('Goblin Barrel', 3, '202', '120', 1.1, '109', '0', '0.5(Melee: Short)', 3),
('Goblin Cage', 4, 742, NULL, NULL, NULL, NULL, NULL, 1),
('Goblin Drill', 4, 1440, NULL, NULL, NULL, NULL, NULL, 1),
('Goblin Gang', 3, '202/133', '120/81', '1.1', '109/48', '0/0', '0.5(Melee: Short)/5', 6),
('Goblin Giant', 6, '3,147', '176', 1.5, '117', '0', '1.2(Melee: Medium)', 1),
...
('Golden Knight', 4, '2,000', '160', 0.9, '177', '0', '1.2(Melee: Medium)', 1),
('Golem', 8, '5,120', '312', 2.5, '124', '224(Death)', '0.75(Melee: Short)', 1),
('Graveyard', 5, NULL, NULL, NULL, NULL, NULL, NULL, 15),
('Guards', 3, '81(+240)', '121', 1, '121', '0', '1.6(Melee: Long)', 3),
('Hog Rider', 4, '1,696', '318', 1.6, '198', '0', '0.8(Melee: Short)', 1),
('Hunter', 4, '838', '84(x10)', 2.2, '381', '0', '4', 1),
('Heal Spirit', 1, '231', '110', NULL, NULL, '0', '2.5', 1),
...
('Miner', 3, '1,210', '193(58)', 1.2, '160 (48 to Towers)', '0', '1.2(Melee: Medium)', 1),
('Mini P.E.K.K.A', 4, '1,361', '720', 1.8, '450', '0', '0.8(Melee: Short)', 1),
('Minion Horde', 3, '230', '102', 1, '102', '0', '1.6(Melee: Long)', 6),
('Minions', 3, '230', '102', 1, '102', '0', '1.6(Melee: Long)', 3),
('Mirror', 'mirrored card+1', 'mirrored card', 'mirrored card', 'mirrored card', 'mirrored card', 'mirrored card', 'mirrored card', 'mirrored card'),
('Monk', 4, '2,000', '140/420', 0.9, '156', '0', '1.2(Melee: Medium)', 1),
('Mortar', 4, 1472, 266, 5, 53, NULL, '3-11.5', 1),
('Mother Witch', 4, '532', '133', 1.1, '121', '0', '5.5', 1),
('Musketeer', 4, '720', '218', 1, '218', '0', '6', 1),
...
('Royal Hogs', 5, '837', '74', 1.2, '61', '0', '0.7(Melee: Short)', 4),
('Royal Recruits', 7, '532(+240)', '133', 1.3, '102', '0', '1.6(Melee: Long)', 6),
('Skeleton Army', 3, '81', '81', 1, '81', '0', '0.5(Melee: Short)', 15),
('Skeletons', 1, '81', '81', 1, '81', '0', '0.5(Melee: Short)', 3),
('Skeleton Barrel', 3, '532', '133', NULL, NULL, '133(Death)', '0.35(Melee: Short)', 1),
('Skeleton Dragons', 4, '532', '161', 1.9, '85', '0', '3.5', 2),
('Skeleton King', 4, '2,300', '205', 1.6, '128', '0', '1.2(Melee: Medium)', 1),
...
CREATE TABLE cards(
	...
	HitSpeed VARCHAR(32),
	Dps VARCHAR(32),
	Spawn_DeathDamage VARCHAR(32),
	AttackRange VARCHAR(32),
